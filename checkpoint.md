...
- [x] 图案切换平滑过渡：旧粒子逐步替换为新图案，无残留
- [x] 主题参数平滑插值：密度/风力/透明度渐变过渡
...
1. 打包并发布 v1.2.0：生成 GitHub Release、推送 Gitee Tag
2. 提交 v1.2.0 到 uTools 插件市场审核
3. 根据审核反馈修复问题
4. 规划 v1.3.0：重点考虑更多节日主题、粒子自定义或代码模块化
...
- **v1.2.0 核心功能**：约 95% 完成（代码已提交，待发布上架）
